...
public class DeepAssetUtil {
    ...
    public static long initRecognizer(Context context) {
        ...
        String finemapping_prototxt = SDCARD_DIR + File.separator + HORIZONAL_FINEMAPPING_PROTOTXT;
        String finemapping_caffemodel = SDCARD_DIR + File.separator + HORIZONAL_FINEMAPPING_CAFFEMODEL;
